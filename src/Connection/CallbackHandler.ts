...
export class CallbackHandler {
    ...
    /**
     * A {@link CallbackList} awaiting {@link LicenseStateResponse} reponses from the Service.
     */
    ...
    ClearUnresponsivePromises(): void {
        ...
        CallbackHandler.ClearUnresponsiveItems(lastClearTime, this.licenseStateCallbacks);
        CallbackHandler.ClearUnresponsiveItems(lastClearTime, this.licenseChangeCallbacks);
    }
