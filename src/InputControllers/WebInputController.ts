...
export class WebInputController extends BaseInputController {
    ...
    private handlingCloseToSwipe = false;
    ...
    private GetElementsOnDown(position: number[]): HTMLElement[] {
        return document
            ...
            .filter(
                (e) =>
                    e &&
                    !e.classList.contains('touchfreecursor') &&
    ...
    protected BumpPage(element: HTMLElement, direction: SwipeDirection): void {
        ...
        switch (direction) {
            case SwipeDirection.UP:
                ...
                extraBumpDistance =
                    this.bumpDistancePx - (element.scrollHeight - element.clientHeight - element[scrollProperty]);
                swipePolarity = -1;
                break;
            case SwipeDirection.DOWN:
            ...
            case SwipeDirection.LEFT:
                ...
                extraBumpDistance =
                    this.bumpDistancePx - (element.scrollWidth - element.clientWidth - element[scrollProperty]);
                swipePolarity = -1;
                break;
            case SwipeDirection.RIGHT:
